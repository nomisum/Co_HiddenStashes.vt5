...
[{
    {[player, 1] call grad_lbm_fnc_setPermissionLevel} remoteExec ["call",INDEPENDENT,true];
...
[{
    {[player, 2] call grad_lbm_fnc_setPermissionLevel} remoteExec ["call",INDEPENDENT,true];
