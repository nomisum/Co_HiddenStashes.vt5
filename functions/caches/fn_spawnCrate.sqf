...

{
    ...
    false
} count ["riflesINDEPENDENT","riflesEast","sniperINDEPENDENT","sniperEast"];
...

{
    ...
    false
} count ["launchersINDEPENDENT","launchersEast"];

{
    ...
    false
} count ["accessoriesINDEPENDENT","accessoriesEast","sightsINDEPENDENT","sightsEast","scopesINDEPENDENT","scopesEast","sniperScopesINDEPENDENT","sniperScopesEast","medical","items"];
