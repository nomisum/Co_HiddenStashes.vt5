...
[format ["wita_cacheMarker_blufor_%1",_cacheID],_bluforMarkerPos,"ICON",[1,1],"TYPE:","mil_unknown","COLOR:","ColorUNKNOWN"] remoteExec ["CBA_fnc_createMarker",INDEPENDENT,true];
